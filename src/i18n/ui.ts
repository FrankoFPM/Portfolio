...
export const ui = {
  es: {
    ...
    'project.contribution': 'Mi aporte',
    'section.projectsIntro': 'Una selección de proyectos: los de BCP Consulting son trabajo en equipo del que formé parte; los personales y freelance, por mi cuenta.',
  ...
  en: {
    ...
    'project.contribution': 'My role',
    'section.projectsIntro': 'A selection of projects: the BCP Consulting ones are team efforts I was part of; personal and freelance work is my own.',
    'skills.backend': 'Backend',
    'skills.frontend': 'Frontend',
    'skills.cloud': 'Cloud & DevOps',
    'skills.data': 'Data & AI',
